    ...
    <s.Screen>
      ...
      >
        ...
        <s.Container jc={"center"} ai={"center"} style={{ width: "100%" }}>
          ...
          >
            CryptosAlien 👽 are 5555 colorfull collectible (NFT) living on polygon blockchain inspiration from CryptoSkulls 💀
            Created By eEEXxxxXEEe
          </s.TextDescription>
          <s.SpacerSmall />
          <s.TextDescription
            style={{
          ...
          >
            Aliens gas limit to {CONFIG.GAS_LIMIT} for the contract to
            successfully mint your ALIENS
          </s.TextDescription>
        </s.Container>
      </s.Container>
    </s.Screen>
